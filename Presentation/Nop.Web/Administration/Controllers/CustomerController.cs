    ...
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected CustomerModel PrepareCustomerModelForList(Customer customer)
        {
            return new CustomerModel()
            {
                ...
                ApplyStoreState = customer.ApplyStoreState
            };
        }
            ...
            [ModelBinder(typeof(CommaSeparatedModelBinder))] int[] searchCustomerRoleIds)
        {
            ...
            if (!String.IsNullOrWhiteSpace(model.SearchApplyStoreState))
                searchApplyStoreState = Convert.ToInt32(model.SearchApplyStoreState);
            ...
            var customers = _customerService.GetAllCustomers(
                ...
                searchApplyStoreState: searchApplyStoreState,
        ...
        public ActionResult Edit(int id)
        {
            ...
            PrepareVendorsModel(model);
            //Apply store state
            model.ApplyStoreState = customer.ApplyStoreState;
            //customer attrivutes
        ...
        public ActionResult Edit(CustomerModel model, bool continueEditing, FormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //Apply store state
                    customer.ApplyStoreState = model.ApplyStoreState;
